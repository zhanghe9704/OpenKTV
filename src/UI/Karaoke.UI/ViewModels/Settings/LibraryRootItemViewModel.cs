...
{
    public LibraryRootItemViewModel(string name, string path, int? defaultPriority, string? defaultChannel, string? driveOverride, string? keywordFormat = null, bool shouldRescan = true)
    {
        OriginalName = name;
        _name = name;
        _path = path;
