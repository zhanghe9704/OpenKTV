...
public interface ILibraryIngestionService
{
    ...
    Task<LibraryIngestionResult> ScanNormalizeOnlyAsync(IEnumerable<string> rootNames, CancellationToken cancellationToken, IProgress<ScanProgress>? progress = null);
}
